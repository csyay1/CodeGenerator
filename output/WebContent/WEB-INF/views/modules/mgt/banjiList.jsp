...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/mgt/banji/">Banji列表</a></li>
		<shiro:hasPermission name="mgt:banji:edit"><li><a href="${ctx}/mgt/banji/form">Banji添加</a></li></shiro:hasPermission>
	</ul>
