...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/mgt/banji/">Banji列表</a></li>
		<li class="active"><a href="${ctx}/mgt/banji/form?id=${banji.id}">Banji<shiro:hasPermission name="mgt:banji:edit">${not empty banji.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="mgt:banji:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
